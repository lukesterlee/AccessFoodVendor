...
public class LocationRegisteringActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks,
...
//                    }
    ...
    //                addressString = (String.valueOf(crossStOne.getText()) + " & "+ (String.valueOf(crossStTwo.getText())));
                    ...
                    if(lat ==null){
                        Toast.makeText(LocationRegisteringActivity.this, "Location is missing", Toast.LENGTH_SHORT).show();
                    }
                    else if(addressString==null || addressString.equals("")){
                        Toast.makeText(LocationRegisteringActivity.this, "Cross Streets are missing", Toast.LENGTH_SHORT).show();
                    }else {
                        ...
                        query.getInBackground(truckId, new GetCallback<ParseObject>() {
                            ...
                            public void done(ParseObject currentVendor, ParseException e) {
                                if (e == null) {
                                    ...
                                    Toast.makeText(LocationRegisteringActivity.this, "Location is saved!", Toast.LENGTH_SHORT).show();

                                    Intent intent = new Intent(LocationRegisteringActivity.this, HoursRegistrationActivity.class);
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(LocationRegisteringActivity.this, MainActivity.class);
//                intent.putExtra("truckId", truckId);
//                startActivity(intent);
//            }
//        });
